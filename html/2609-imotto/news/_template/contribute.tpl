...
<title>{=$title=}｜相模原市・厚木市のアイモット</title>
<ONIf condition="$keyword">
<meta name="keywords" content="{=$keyword=}">
<ONElse>
<meta name="keywords" content="{=$title=},{=$current_category_name=},相模原市,厚木市,アイモット">
</ONIf>
<ONIf condition="$description">
<meta name="description" content="{=$description=}">
<ONElse>
<meta name="description" content="{=$title=}相模原市・厚木市の不動産売却・相続相談はアイモットへ。">
</ONIf>
...
<meta property="og:url" content="https://www.imotto.co.jp/news/{=$url=}">
<meta property="og:title" content="{=$title=}｜相模原市・厚木市のアイモット">
<meta property="og:site_name" content="不動産のアイモット">
<meta property="og:phone_number" content="0120-984-113">
<ONIf condition="$description">
<meta property="og:description" content="{=$description=}">
<ONElse>
<meta property="og:description" content="{=$title=}相模原市・厚木市の不動産売却・相続相談はアイモットへ。">
</ONIf>
...
<link rel="canonical" href="https://www.imotto.co.jp/news/{=$url=}">
...
<script type="application/ld+json">
{
    ...
    },
    {
        ...
        "position": 4,
        "name": "{=$title=}",
        "item": "https://www.imotto.co.jp/news/{=$url=}"
    }]
}
</script>
</head>
        ...
        <header>
            <div class="h_box">
                <div class="inner h_inner">
                    ...
                    <div class="h_left">
                        <?php if ($h1 == $title) { ?>
                             <h1 id="logo"><a href="../../"><img src="../../images/logo.png" alt="{=$title=}" width="400" height="60"></a></h1>
                        <?php } else  { ?>
                            <h1 id="logo"><a href="../../"><img src="../../images/logo.png" alt="{=$h1=}" width="400" height="60"></a></h1>
                        <?php } ?>
                ...
                <div class="inner clearfix">
					...
					<section class="clearfix">
                        ...
                        <ul class="btn_list">
                            ...
                            <?php endif; ?>
                            <li class="is_none btn h_over"><a href="../{=$current_category_url=}/">一覧へ戻る</a></li>
