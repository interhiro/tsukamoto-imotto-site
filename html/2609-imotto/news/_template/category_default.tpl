...
<title>{=$current_category_name=}｜相模原市・厚木市のアイモット</title>
<meta name="keywords" content="相模原市,厚木市,不動産売却情報,不動産相続,空き家,住み替え,住宅ローン,収益用不動産,アイモット">
<meta name="description" content="相模原市・厚木市の不動産売却、買取、相続、空き家、住み替え、住宅ローン、収益用不動産に関するお役立ち情報を、アイモットが分かりやすく発信します。">
...
<meta property="og:url" content="https://www.imotto.co.jp/news/{=$current_category_url=}/">
<meta property="og:title" content="{=$current_category_name=}｜相模原市・厚木市のアイモット">
<meta property="og:site_name" content="不動産のアイモット">
<meta property="og:phone_number" content="0120-984-113">
<meta property="og:description" content="相模原市・厚木市の不動産売却、買取、相続、空き家、住み替え、住宅ローン、収益用不動産に関するお役立ち情報を、アイモットが分かりやすく発信します。">
...
<link rel="canonical" href="https://www.imotto.co.jp/news/{=$current_category_url=}/">
...
<script type="application/ld+json">
{
    ...
    },
    {
        ...
        "item": "https://www.imotto.co.jp/news/{=$current_category_url=}/"
    }]
}
</script>
</head>
        ...
        <header>
            <div class="h_box">
                <div class="inner h_inner">
                    <!-- Header Content -->
                    <div class="h_left">
                        <h1 id="logo"><a href=""><img src="../../images/logo.png" alt="{=$current_category_name=}｜相模原市・厚木市のアイモット" width="400" height="60"></a></h1>
                         <!-- Nav Menu -->
                        <nav>
                                <ul class="nav_list">
                                    <li class="parent">
                ...
                <div class="inner clearfix">
                	<section class="clearfix">
                        <div class="list_anchor">
							<ONCategory>
								<?php if( $current_category_id==$category_id ){ ?>
                                 <p class="btn h_over cate{=$category_id=} active"><a href="../{=$category_url=}/">{=$category_name=}</a></p>
                                <?php } else { ?>
                                 <p class="btn h_over cate{=$category_id=}"><a href="../{=$category_url=}/">{=$category_name=}</a></p>
                                <?php } ?>
                            </ONCategory>
						</div>
						
						<div class="box_list_ovn">
							<?php 
								$limitNum = 12;
								function get_the_content_image($content = null) {
								    $first_img = '';
								    if($content){
							...
							<ONContributeFetch>
								<div class="item">
									<p class="img_ovn">
										<?php 
											$thumbnail = $img_Value ? $img_Src : get_the_content_image($text1_Value);
											$thumbnail = $thumbnail ?: "../../images/dummy.jpg";
										?>
										<img src="{=$thumbnail=}" alt="{=$title=}">
									<div class="info_ovn">
										<p class="cate_ovn"><span class="txt">{=$category_name=}</span></p>
										<p class="name_ovn"><span class="txt">{=$title=}</span></p>
									</div>
									<a href="../{=$url=}" class="full_hover" aria-label="{=$title=}"></a>
								</div>
