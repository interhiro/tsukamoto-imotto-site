...
<title><?php echo $current_category_name; ?>｜相模原市・厚木市のアイモット</title>
...
<meta property="og:url" content="https://www.imotto.co.jp/news/<?php echo $current_category_url; ?>/">
<meta property="og:title" content="<?php echo $current_category_name; ?>｜相模原市・厚木市のアイモット">
...
<link rel="canonical" href="https://www.imotto.co.jp/news/<?php echo $current_category_url; ?>/">
        ...
        <header>
            <div class="h_box">
                <div class="inner h_inner">
                    <!-- Header Content -->
                    <div class="h_left">
                        <h1 id="logo"><a href="../../../"><img src="../../images/logo.png" alt="<?php echo $current_category_name; ?>｜相模原市・厚木市のアイモット" width="400" height="60"></a></h1>
                         <!-- Nav Menu -->
                        <nav>
                                <ul class="nav_list">
                                    <li><a href="../../../">ホーム</a></li>
...
?>
								<?php if( $current_category_id==$category_id ){ ?>
                                 <p class="btn h_over cate<?php echo $category_id; ?> active"><a href="../<?php echo $category_url; ?>/"><?php echo $category_name; ?></a></p>
                                <?php } else { ?>
                                 <p class="btn h_over cate<?php echo $category_id; ?>"><a href="../<?php echo $category_url; ?>/"><?php echo $category_name; ?></a></p>
                                <?php } ?>
                            <?php
	}
?>
...
?>
								<div class="item">
									...
									<div class="info_ovn">
										<p class="cate_ovn"><span class="txt"><?php echo $category_name; ?></span></p>
										<p class="name_ovn"><span class="txt"><?php echo $title; ?></span></p>
									</div>
									<a href="../<?php echo $url; ?>" class="full_hover" aria-label="<?php echo $title; ?>"></a>
								</div>
