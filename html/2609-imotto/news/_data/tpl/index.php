...
<title>不動産売却・相続のお役立ち情報｜相模原市・厚木市のアイモット</title>
...
<meta property="og:url" content="https://www.imotto.co.jp/news/">
<meta property="og:title" content="不動産売却・相続のお役立ち情報｜相模原市・厚木市のアイモット">
...
<link rel="canonical" href="https://www.imotto.co.jp/news/">
	...
	<header>
		<div class="h_box">
			<div class="inner h_inner">
				<!-- Header Content -->
				<div class="h_left">
					<h1 id="logo"><a href="../../../"><img src="../images/logo.png" alt="不動産売却・相続のお役立ち情報" width="400" height="60"></a></h1>
					<!-- Nav Menu -->
					<nav>
						<ul class="nav_list">
							<li><a href="../../../">ホーム</a></li>
		...
		<div id="content">
			...
			<div class="inner clearfix">
				...
				<section class="clearfix">
					<div class="list_anchor list_anchor_ovn">
						<?php
...
?>
							<p class="btn h_over"><a href="./<?php echo $category_url; ?>/"><?php echo $category_name; ?></a></p>
						<?php
	}
?>
					</div>
