...
<title>不動産売却の無料査定・相談｜相模原市・厚木市のアイモット</title>
<meta name="keywords" content="相模原市,厚木市,不動産無料査定,不動産相談,売却査定,買取査定,相続相談,空き家相談">
<meta name="description" content="相模原市・厚木市の不動産売却、買取、相続、住み替え、空き家管理に関する無料査定・相談はこちら。詳しい住所が分からない場合も、分かる範囲の入力でご相談いただけます。">
...
<meta property="og:url" content="https://www.imotto.co.jp/contact/">
<meta property="og:image" content="https://www.imotto.co.jp/images/ogp.jpg">
<meta property="og:title" content="不動産売却の無料査定・相談｜相模原市・厚木市のアイモット">
<meta property="og:site_name" content="不動産のアイモット">
<meta property="og:description" content="相模原市・厚木市の不動産売却、買取、相続、住み替え、空き家管理に関する無料査定・相談はこちら。詳しい住所が分からない場合も、分かる範囲の入力でご相談いただけます。">
...
<link rel="canonical" href="https://www.imotto.co.jp/contact/">
<!-- JSON BREADCRUMBS -->
<script type="application/ld+json">
{
    ...
    },
    {
        ...
        "position": 2,
        "name": "お問い合わせ・査定依頼",
        "item": "https://www.imotto.co.jp/contact/"
    }]
}
</script>
</head>
...
<!-- End Google Tag Manager (noscript) -->
        ...
        <header>
            <div class="h_box">
                <div class="inner h_inner">
                    <!-- Header Content -->
                    <div class="h_left">
                        <h1 id="logo"><a href="../"><img src="../images/logo.png" alt="相模原市・厚木市の不動産無料査定・ご相談" width="400" height="60"></a></h1>
                         <!-- Nav Menu -->
                        <nav>
                                <ul class="nav_list">
                                    <li><a href="../">ホーム</a></li>
                ...
                <div class="inner clearfix">
                    <div class="u_content">
                        ...
                        <section class="clearfix">
                            <h3><span class="txt">お問い合わせ・査定依頼</span></h3>
                            <p class="txt-tag3">相模原市・厚木市を中心とした不動産売却、買取、相続、住み替え、空き家管理などのご相談は、アイモットへお問い合わせください。まだ売却を決めていない方や、詳しい物件情報が分からない方も問題ありません。分かる範囲でご入力いただければ、楠本代表が内容を確認し、必要なことを一緒に整理します。</p>
                        </section>
                        <section class="clearfix">
                            <h3><span class="txt">分かる範囲の<br class="pc">ご入力で構いません</span></h3>
                            <p class="txt-tag3">不動産について相談したいと思っても、住所、名義、築年数などがすぐに分からないことがあります。すべての情報を調べてからお問い合わせいただく必要はありません。入力内容が正確でない場合も、確認しながら進めます。まずは現在のお悩みやご希望をお知らせください。</p>
                        </section>
                    </div>
                    <section class="clearfix">
                        <h4>このようなご相談に対応しています</h4>
                        <ul class="list01">
                            <li>不動産がいくらで売れるか知りたい</li>
                            <li>仲介と買取のどちらがよいか相談したい</li>
                            <li>相続した不動産について相談したい</li>
                            <li>空き家や空き地の管理に困っている</li>
                            <li>不要な不動産を整理したい</li>
                            <li>住み替えに伴い自宅を売却したい</li>
                            <li>住宅ローンの返済負担を見直したい</li>
                            <li>残置物や不用品が多く、売却方法が分からない</li>
                            <li>他社へ依頼しているが売却が進まない</li>
                            <li>売却を決める前に楠本代表へ相談したい</li>
                        </ul>
                    </section>
                    <div class="u_content u_content2"  id="fmail_form">
                        <section class="clearfix">
                            <h3><span class="txt">お問い合わせフォーム</span></h3>
                            <p class="txt-tag3">以下の項目へ、分かる範囲でご入力ください。<br>必須項目以外は、未入力でもお問い合わせいただけます。</p>
                        </section>
                    </div>
                    ...
                    <div class="u_content u_content2">
                        <section class="clearfix">
                            <h3><span class="txt">プライバシーポリシー</span></h3>
                            <p class="txt-tag3">i Motto株式会社（以下「当社」といいます）は、お客様からお預かりする個人情報を適切に取り扱い、保護することを重要な責務と考えています。</p>
                        </section>
                    </div>
                    <section class="clearfix">
                        <h4>個人情報の利用目的</h4>
                        <p>当社は、お問い合わせフォームなどを通じて取得した氏名、メールアドレス、電話番号、物件情報、相談内容などの個人情報を、以下の目的で利用します。</p>
                        <ul class="list01">
                            <li>お問い合わせやご相談への回答</li>
                            <li>不動産の査定、売却、買取、購入、管理などのご案内</li>
                            <li>ご依頼いただいたサービスの提供および連絡</li>
                            <li>必要な資料や情報の送付</li>
                            <li>当社サービスの改善</li>
                        </ul>
                    </section>
                    <section class="clearfix">
                        <h4>個人情報の管理</h4>
                        <p>当社は、個人情報の漏えい、紛失、改ざん、不正アクセスなどを防止するため、必要かつ適切な安全管理措置を講じます。</p>
                    </section>
                    <section class="clearfix">
                        <h4>個人情報の第三者提供</h4>
                        <p>当社は、法令に基づく場合またはお客様の同意を得た場合を除き、個人情報を第三者へ提供しません。<br>ただし、不動産取引やご相談への対応に必要な範囲で、司法書士、税理士、弁護士、土地家屋調査士、金融機関、工事・管理業者などへ情報を提供する場合は、あらかじめお客様へご説明し、同意をいただきます。</p>
                    </section>
                    <section class="clearfix">
                        <h4>個人情報の開示・訂正・削除</h4>
                        <p>お客様ご本人から、個人情報の開示、訂正、利用停止、削除などのご希望があった場合は、ご本人であることを確認したうえで、法令に従い対応します。</p>
                    </section>

                    <section class="clearfix">
                        <h4>お問い合わせ窓口</h4>
                        <p>個人情報の取り扱いに関するお問い合わせは、以下までご連絡ください。<br>i Motto株式会社<br>〒220-0012<br>神奈川県横浜市西区みなとみらい3-7-1<br>オーシャンゲートみなとみらい10F<br>電話番号：045-315-4082</p>
                    </section>
				</div>
            </div>
            <!-- content end -->
                    ...
                    <div class="box_left">
                        ...
                        <div class="box_info_map">
                            ...
                            <div class="info_map info_map1">
                                <dl>
                                    <dt>所在地</dt>
                                    <dd>神奈川県横浜市西区<br>みなとみらい３－７－１<br>オーシャンゲートみなとみらい１０F</dd>
                                </dl>
                                <dl>
                                    <dt>アクセス</dt>
                                    <dd>東横線（みなとみらい線）<br>みなとみらい駅　徒歩2分</dd>
                                </dl>
                                <dl>
                                    <dt>営業時間</dt>
                                    <dd>9：00～21：00（不定休）</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(window).bind('load', function() {
            if ($('#d_en1711012711').length) {
                $('#d_en1711012711').attr('colspan', '2');
            }
        });
    </script>
</body>
