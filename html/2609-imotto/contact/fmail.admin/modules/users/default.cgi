...
for($cnt=0;$cnt<@users;$cnt++){
	...
	$users_list .= "<td><a href=\"?m=$form{'m'}&a=form&id=$users_info[0]&power=$users_info[2]\">${users_info[4]}($power{$users_info[2]})</a></td>\n";
	# 2023.3.9 ver5.043 管理者IDを変更操作可とする対応 &power=$users_info[2] URLパラメータを追加
	$users_list .= "<td style=\"width: 40px;\"><img src=\"images/button_edit.gif\" width=\"50\" height=\"20\" alt=\"編集\" class=\"button\" onclick=\"location.href='?m=$form{'m'}&a=form&id=$users_info[0]&power=$users_info[2]'\" /></td>\n";
